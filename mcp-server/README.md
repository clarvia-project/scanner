...
**MCP server for Clarvia — search, evaluate, and gate-check 27,800+ AI agent tools**
...
| Tool | Description |
|------|-------------|
| `search_services` | Search 27,800+ indexed AI tools (MCP servers, APIs, CLIs) by keyword, category, or minimum AEO score |
