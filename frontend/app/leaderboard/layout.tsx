...
export const metadata: Metadata = {
  ...
  description:
    "The definitive ranking of AI agent tools by AEO score. See which MCP servers, APIs, CLIs, and skills rank highest for agent readiness across 27,843+ indexed tools.",
  keywords: [
  ...
  twitter: {
    ...
    title: "AI Agent Tool Leaderboard — Top AEO Scores | Clarvia",
    description:
      "Top-ranked MCP servers and AI agent tools by AEO score. 27,843+ tools analyzed.",
  },
  alternates: {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
        ...
        acceptedAnswer: {
          ...
          text:
            tools.length > 0
              ...
              : "Clarvia ranks 27,843+ AI agent tools by AEO score. The top tools score 90+ out of 100 across documentation, error handling, structured outputs, and agent discoverability.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "The Clarvia leaderboard is updated daily as tools are re-scanned and new tools are added to the index. Over 27,843 tools are tracked continuously.",
        },
      },
    ],
  };
      ...
      {tools.length > 0 && (
        ...
        >
          ...
          <p>
            ...
            AEO (AI Engine Optimization) benchmark out of 27,843+ indexed tools.
          </p>
          <ol>
